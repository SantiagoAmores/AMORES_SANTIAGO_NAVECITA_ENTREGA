...
public class Moneda : MonoBehaviour
{
    ...
    public float maxRotacion = 200f;     // Velocidad máxima de rotación
    ...
    private void Start()
    {
        ...
        if (nave == null)
        {
            nave = GameObject.FindWithTag("Player").transform; // Asegúrate de que la nave tenga el tag "Player"
        }
    }
    ...
    private void Update()
    {
        ...
        if (nave != null)
        {
            ...
            float velocidadRotacion = Mathf.Lerp(maxRotacion, rotacionBase, distancia / 10f); // Aumenta la velocidad al acercarse
